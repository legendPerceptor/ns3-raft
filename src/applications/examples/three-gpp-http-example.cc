...
main (int argc, char *argv[])
{
  ...
  LogComponentEnable("ThreeGppHttpClient",LogLevel(LOG_INFO|LOG_DEBUG));
  LogComponentEnable("ThreeGppHttpServer",LogLevel(LOG_INFO|LOG_DEBUG));
...
//  Object::AggregateIterator iter = serverApps.Get(0)->GetAggregateIterator();
//  while(iter.HasNext()){
