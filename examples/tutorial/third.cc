...
//    anim.SetConstantPosition(wifiStaNodes.Get(0),50.0,50.0);
//    anim.SetConstantPosition(wifiStaNodes.Get(1),30.0,60.0);
//    anim.SetConstantPosition(wifiStaNodes.Get(2),20.0,40.0);
